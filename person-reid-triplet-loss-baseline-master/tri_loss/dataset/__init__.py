...
def create_dataset(
  ...
  if name == 'market1501':
    ...
    im_dir = ospeu('/home/zhang/E/lzp/market_forid4shuju/images')
    partition_file = ospeu('/home/zhang/E/lzp/market_forid4shuju/partitions.pkl')
  elif name == 'cuhk03':
    ...
    im_dir = ospeu('/home/zhang/E/lzp/duke_shuju/images')
    partition_file = ospeu('/home/zhang/E/lzp/duke_shuju/partitions.pkl')
